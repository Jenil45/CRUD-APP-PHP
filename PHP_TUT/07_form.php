...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    // inserting data
    $sql = "INSERT INTO `contact_us` (`Sr No`, `Name`, `Email`, `Description`) VALUES ('1', '$name' , '$email' , '$description');";
    $result = mysqli_query($connection , $sql);


    // check our query succesfullness
    if($result)
    {
    ...
    {
        echo  "<br> the error has occured in insertion of data  -----> ".mysqli_error($connection);
    }
}
...
<form action="/PHP_TUT/07_form.php" method="post">
  <div class="mb-3">
